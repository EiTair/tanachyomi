...
/**
 * The JewishDate is the base calendar class, that supports maintenance of a {@link GregorianCalendar}
 ...
 *
 * @see com.eitankri.tanachyomi.JewishCalendar
 * @see com.eitankri.tanachyomi.HebrewDateFormatter
 * @see Date
 * @see Calendar
...
public class JewishDate implements Comparable<JewishDate>, Cloneable {
	 ...
	 * @see com.eitankri.tanachyomi.HebrewDateFormatter#getFormattedKviah(int)
	 */
	 ...
	 *            constants such as {@link com.eitankri.tanachyomi.JewishDate#TISHREI}.
	...
	/**
	 * Converts the {@link com.eitankri.tanachyomi.JewishDate#NISSAN} based constants used by this class to numeric month starting from
	 * {@link com.eitankri.tanachyomi.JewishDate#TISHREI}. This is required for Molad claculations.
	 *
	 * @param year
	 *            The Jewish year
	 * @param month
	 ...
	 *            a leap year, 13 will be the expected value for Adar II. Use the constants {@link com.eitankri.tanachyomi.JewishDate#NISSAN}
	 *            etc.
	 * @param dayOfMonth
	 ...
	 */
	public com.eitankri.tanachyomi.JewishDate getMolad() {
		com.eitankri.tanachyomi.JewishDate moladDate = new com.eitankri.tanachyomi.JewishDate(getChalakimSinceMoladTohu());
	 ...
	 *            the Jewish day of month. If 30 is passed in for a month with only 29 days (for eitankri {@link #IYAR},
	...
	public void setJewishDate(int year, int month, int dayOfMonth, int hours, int minutes, int chalakim) {
		...
		// if 30 is passed for a month that only has 29 days (for eitankri by rolling the month from a month that had 30
	 ...
	 * @see com.eitankri.tanachyomi.HebrewDateFormatter#format(com.eitankri.tanachyomi.JewishDate)
	 */
	public String toString() {
		return new com.eitankri.tanachyomi.HebrewDateFormatter().format(this);
	}
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof com.eitankri.tanachyomi.JewishDate)) {
			return false;
		}
		com.eitankri.tanachyomi.JewishDate jewishDate = (com.eitankri.tanachyomi.JewishDate) object;
	 ...
	 * they are equal.
	 */
	public int compareTo(com.eitankri.tanachyomi.JewishDate jewishDate) {
	 ...
	 */
	public Object clone() {
		com.eitankri.tanachyomi.JewishDate clone = null;
		try {
			clone = (com.eitankri.tanachyomi.JewishDate) super.clone();
