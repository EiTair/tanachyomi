...
public class JewishCalendar extends JewishDate {
	...
	private boolean inIsrael = true;
	private boolean useModernHolidays = true;
	 ...
	 * returns Parsha.NONE if a weekday or if there is no parshah that week (for eitankri Yomtov is on Shabbos)
	...
	public boolean equals(Object object) {
		...
		if (!(object instanceof com.eitankri.tanachyomi.JewishCalendar)) {
			return false;
		}
		com.eitankri.tanachyomi.JewishCalendar jewishCalendar = (com.eitankri.tanachyomi.JewishCalendar) object;
